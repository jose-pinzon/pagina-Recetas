...
@section('content')
    ...
    <h1 class="text-center mb-5">Crea tus recetas </h1>
            ...
            <form action="{{route('recetas.store')}}" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('titulo') is-invalid @enderror" {{--TODO: este es para resaltar el input si hay error --}}
                            ...
                            value="{{old('titulo')}}" {{-- TODO: por si llegara haber un error se mantenga el dato --}}>
                ...
                <div class="form-group">
                    ...
                    <select name="categoria" id="category" class="form-control @error('categoria') is-invalid  @enderror">
                            ...
                            @foreach ($categorias as $cate){{-- se hace asi porque solo en el controlador se uso un plock --}}
                                <option value="{{ $cate->id }}"  {{old('categoria') == $cate->id ? 'selected' : ''}}> {{ $cate->nombre}} </option>
                            @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input id="preparar" type="hidden" name="preparar" value="{{ old('preparar') }}">
